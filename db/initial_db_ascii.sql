...
CREATE TABLE tourist_site(
   ...
   tourist_site_area_name          VARCHAR(50)    NOT NULL
   );

--inserting data into the table created
INSERT INTO tourist_site(tourist_site_name,tourist_site_image,tourist_alt_name,region_shortname,tourist_site_description,tourist_site_area_name) VALUES
...
and officially opened on 12 August 1995 by the then king, Otumfuo Opoku Ware II.','Kumasi'),
...
in 1953. It is an old Uaddara barracks that has  a substantial collection of weapons, photographs, and medals.','Kumasi'),
...
recreational area. Lake Bosumtwe is a lake formed by an ancient meteorite strike in the Ashanti Region.','Kumasi'),
...
present at the event that the day the sword would be uprooted, the Asante Kingdom would collapse.','Kumasi'),
...
the Independence Arch, one of the National monuments in remembrance of the 6th March 1957, as the previous British colony
 Gold Coast was released into the independency and the new Republic of Ghana was founded.','Accra'),
...
(by then Gold Coast) from colonial rule in 6th March,1957.','Accra'),
...
'The National Theatre, opened in 1992 and located in the Victoriaborg district of Accra, Ghana, was built by the Chinese
 and offered as a gift to Ghana. The theatre is governed by the National Theatre Law 1991, PNDC Law 259.','Accra'),
...
'Fiema is a popular tourist attraction in the Nkoranza North District, a district in the Brong-Ahafo Region of Ghana.
 It is informally known as the Boabeng-Fiema monkey sanctuary. It is a home for about 700 monkeys.','Techiman'),
...
machine-made textiles.','Techiman'),
...
'30km west of Takoradi, at the Akatekyi Lagoon, you will find a pond where crocodiles are enticed from the water by the
 ...
 embodiment of the people in the area.  You can observe this ritual every day except Wednesday (a sacred day).','Takoradi'),
...
'Located on Manfro Hill 5km east of Fort St. Antonio, this fort was built by the Brandeburgers in 1683. Danish lodge
 in 1658, fort built in 1682.','Takoradi'),
...
90 km east of Bolgatanga, history has it that Naa Gbewa, founder of the Mole-Dagbani tribes, finally settled at Pusiga and
 died there in the 13th century. His descendants continue to worship at the shrine.','Bolgatanga'),
...
'Paga Crocodile Pond is located at the Northeast border, this is a sacred sanctuary for crocodiles. The reptiles are enticed
 ...
 is a sanctuary for crocodiles.','Bolgatanga'),
...
'Tongo is a small town near the Upper East regional capital, Bolgatanga, and the capital of Talensi-Nabdam district,
 ...
 for its sowing and harvest festivals.','Bolgatanga'),
...
'Wli Waterfalls is the highest waterfall in Ghana and the tallest in West Africa. It has a lower and an upper fall.
 ...
 waterfalls - meaning, "Allow Me to Flow."','Keta'),
...
in the Volta Region of Ghana.','Keta'),
...
mountain is a tall cross made of iron erected by German missionaries in 1939.','Keta'),
...
supernatural exploits at Awukugua-Akwapim.','Aburi'),
...
'On the Akwapim Ridge the fetish shrine is an important place of traditional healing and religious ceremonies.
 Larteh is 56km north of Accra, on the Akwapim Ridge.','Aburi'),
...
Officially opened the park in 1994.','Cape Coast'),
...
Castle, Cape Coast Castle and the Kakum Rainforest.','Cape Coast'),
...
'Cape Coast Castle is one of about forty "slave castles", or large commercial forts, built on the Gold Coast of West
 Africa (now Ghana) by European traders.','Cape Coast'),
...
known simply as Mina or Feitoria da Mina) in present-day Elmina, Ghana (formerly the Gold Coast). It was the first
 trading post built on the Gulf of Guinea, so is the oldest European building in existence south of the Sahara.','Cape Coast'),
...
'The Gbelle Reserve which measures 565km is an important sanctuary for endangered species of wildlife in the country.
 ...
 elephants, bucks, rhinos, and the largest hers of roan antelopes in Ghana.','Wa'),
...
'Gbollu, 70km north of Wa, was part of the slave route. In the 1`9th century Gbollu Koro Liman built the wall as
 part of its defence against the slavers.','Wa'),
...
of friendship with the British. He was later(1897) killed by slave raiders, but his tomb preserved in Wa.','Wa'),
...
km from Accra and 430km from Kumasi.','Tamale'),
...
'A 13th century mosque, believed to be first built by Moorish traders, it is one of the holiest site in Ghana.
 Its distinctive faade has been widely photographed.','Tamale'),
('Daboya', 'Daboya.JPG', 'Daboya pic','NR', 
'Daboya is 89km west of tamale, Daboya is the 16th century town from the Gonja Kingdom, and a famous source for hand made textiles.','Tamale'),
('Salaga', 'salaga.jpeg', 'salaga pic','NR', 
'The slave route is recognized at Salaga, where the Trans-Sahara caravans paused in Salaga market. Leg pegs can still be seen in the market place.','Tamale');
